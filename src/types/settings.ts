...
export const defaultSettings: AppSettings = {
  apiKeys: {},
  modelSelection: {
    T1: { provider: 'deepseek', model: 'deepseek-chat', enabled: true },
    T2: { provider: 'anthropic', model: 'claude-3-5-sonnet-20241022', enabled: true },
    T3: { provider: 'anthropic', model: 'claude-3-5-sonnet-20241022', enabled: true },
    T4: { provider: 'anthropic', model: 'claude-3-opus-20240229', enabled: true },
  },
  standards: {
    database: {
      namingConvention: {
